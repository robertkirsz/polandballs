...
export const getGalleryByTag = (tag = 'polandball', { sort = 'viral', date = 'week', page = 0 } = {}) =>
...
export const searchGallery = (query, { sortBy = 'time', date = 'all', page = 0 } = {}) =>
  request('Search gallery', `https://api.imgur.com/3/gallery/search/${sortBy}/${date}/${page}?q=${query}`, get)
